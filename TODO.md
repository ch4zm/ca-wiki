# Reading List: Life-Family Cellular Automata

Scope: see **Scope** in `SCHEMA.md`. Verify each citation (volume, pages, URL) at ingest
time; entries here are working references, not checked bibliography.
...
- [ ] Schulman, L. S., & Seiden, P. E. (1978). Statistical mechanics of a dynamical system based on Conway's Game of Life. *Journal of Statistical Physics, 19*(3), 293–314.
