...
category: Patterns
summary: The LWSS, MWSS and HWSS - three period-4 Life spaceships that move orthogonally 2 cells every 4 generations (c/2); with the glider they are by far the commonest spaceships in random soups
tags: [pattern, life, spaceship, lwss, mwss, hwss, orthogonal, c-over-2]
sources: [lifewiki-catagolue, cgol-ch5-glider-synthesis, cgol-ch4-spaceships-and-moving-objects, cgol-ch1-early-life, fantastic-combinations-of-john-conways-life]
created: 2026-09-25
updated: 2026-09-25
---
...
glider are the only spaceships Okrasinski's large soup search found. The larger
[[catagolue](pages/catagolue.md)] census of asymmetric soups has also produced the
sidecar, the loafer, the Schick engine and the Coe ship, far more rarely, and symmetric
soups have produced others such as the copperhead.[^4][^5] Following the naming, the glider was once called the "featherweight
spaceship".[^6]
...
- [[lifewiki-catagolue](pages/lifewiki-catagolue.md)] - the rarer natural spaceships beside them
