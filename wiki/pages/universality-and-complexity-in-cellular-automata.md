...
sources: [theory-of-cellular-automata-a-survey, universality-and-complexity-in-cellular-automata]
created: 2026-09-24
updated: 2026-09-24
---
...
set and measure entropies for blocks of cells in space,
...
new. The paper found no class 4 rule among the symmetric elementary rules it classified,
but the elementary [[rule-110](pages/rule-110.md)] is class 4 and has since been proved computationally
universal.[^18]
...
[^18]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.11 - "Rule 110 is in Wolfram class 4, and Wolfram conjectured in the 1980s that it is computationally universal. Recently this result was established by him and Cook"
