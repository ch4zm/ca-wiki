...
[[r-pentomino](pages/r-pentomino.md)] refuses to settle quickly. Conway followed long runs
like it on a PDP-7 display program by M. J. T. Guy and S. R. Bourne.[^7] Gardner names the stable forms
...
of it orthogonally. Gardner names moving figures [[spaceship](pages/spaceship.md)]s, with the glider as the
"featherweight".[^9] Conway offered $50 for settling whether a finite pattern can grow
without limit, naming a "gun" that emits gliders and a "puffer train" that leaves smoke
as the ways it could; the [[gosper-glider-gun](pages/gosper-glider-gun.md)] settled
it.[^10]
...
- Life was studied both by hand and by computer from the start.[^7]
...
- [[gosper-glider-gun](pages/gosper-glider-gun.md)] - settled the growth prize
...
[^7]: [[fantastic-combinations-of-john-conways-life](pages/fantastic-combinations-of-john-conways-life.md)] pp.4-5 [synthesis] - "The only pentomino that does not end quickly ... is the R pentomino"; "For long-lived populations such as this one Conway sometimes uses a PDP-7 computer ... The program was written by M. J. T. Guy and S. R. Bourne"
...
[^9]: [[fantastic-combinations-of-john-conways-life](pages/fantastic-combinations-of-john-conways-life.md)] pp.4-5 [synthesis] - "The speed a chess king moves in any direction is called by Conway ... the 'speed of light'"; "Conway has proved that the maximum speed diagonally is a fourth the speed of light"; orthogonal movement "cannot exceed half the speed of light"; "which he calls 'spaceships' (the glider is a 'featherweight spaceship' ...)"
[^10]: [[fantastic-combinations-of-john-conways-life](pages/fantastic-combinations-of-john-conways-life.md)] p.3 [synthesis] - $50 prize on whether a pattern can grow without limit; a "gun" (repeatedly shoots out moving objects such as the glider) or a "puffer train" (moves but leaves behind a trail of "smoke"); [[cgol-ch1-early-life](pages/cgol-ch1-early-life.md)] p.11, n.10 - "this glider gun's discovery earned Gosper a $50 reward from Conway himself"
