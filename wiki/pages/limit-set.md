...
**Basic properties** (Culik, Pachl and Yu; Hurd):[^2]
...
Whether a given CA is nilpotent is **undecidable in every dimension** (Culik, Pachl and Yu
for d ≥ 2; Kari for d = 1).[^4]
...
([[classification-of-cellular-automata](pages/classification-of-cellular-automata.md)]).[^7]
...
undecidable.**[^8] Theorem 15 also gives the uncomputability of topological entropy (Hurd,
Kari and Culik).[^9]
...
sets is decidable over a fixed S. Kari asks whether it is the only one.[^10]
...
[^7]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.9 - "every nilpotent CA belongs to class (1) but it has also non-nilpotent members, e.g. rule 128 in which the quiescent state 0 spreads killing all 1's."
[^8]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] pp.24-25 [synthesis] - definition of a property of limit sets "regardless of their state set" and of non-triviality; "the nilpotency problem was successfully reduced to all non-trivial properties of limit sets"; Theorem 16 (Rice's theorem for limit sets, Kari [42])
[^9]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.24 - "Using Theorem 15 one can show that the topological entropy of a given CA is uncomputable [35]."
[^10]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.25 [synthesis] - with S fixed, "a CA is surjective if and only if its limit set contains all configurations over the state set S"; decidable in dimension one by Theorem 9; Open problem 6
