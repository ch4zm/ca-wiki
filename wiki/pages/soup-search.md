...
larger pulsar or pentadecathlon.[^5] Ordinary random soups yield only the glider, LWSS, MWSS and
HWSS as spaceships; symmetric soups have also produced rarer ones such as the c/10
copperhead.[^6] The only infinitely growing patterns seen to arise from random fills are switch-engine
puffers ([[switch-engine](pages/switch-engine.md)]).[^7]
