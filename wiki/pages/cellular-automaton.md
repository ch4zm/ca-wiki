...
neighbourhoods can simulate it.[^33][^34]
...
[^33]: [[aucm-ch14-broadcasting-automata](pages/aucm-ch14-broadcasting-automata.md)] pp.301, 306 [synthesis] — transmission radius dictated by the state, connectivity graph changes each step; variable-neighbourhood CA can simulate Broadcasting Automata, "it is only possible to say that BA ⊆ CA"
