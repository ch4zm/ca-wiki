...
sources: [machine-models-of-self-reproduction, theory-of-cellular-automata-a-survey, aucm-ch14-broadcasting-automata]
created: 2026-09-24
updated: 2026-09-24
---
...
gives the *radius-r* neighbourhoods, so the Moore neighbourhood has radius 1.
In digital geometry the two 2D unit neighbourhoods are the "city block" (von Neumann: moves
along the axes, an L1 diamond) and the "chessboard" (Moore: diagonal moves allowed, an L∞
square). Relaying a message repeatedly through them grows diamond and square waves. They
are also the first two discrete discs, of Euclidean radius² 1 and 2
([[neighbourhood-sequence](pages/neighbourhood-sequence.md)]).[^6] The
...
direction.[^7] One-way rules are used in the XOR counterexamples to the
[[garden-of-eden-theorem](pages/garden-of-eden-theorem.md)], in Kari's 1D nilpotency
proof ([[limit-set](pages/limit-set.md)]), and in
[[language-recognition-by-cellular-automata](pages/language-recognition-by-cellular-automata.md)].[^8]
The [[margolus-neighbourhood](pages/margolus-neighbourhood.md)] is not a neighbourhood in
this sense at all. It partitions the plane into blocks.[^9]

## Appearances in Sources

- [[aucm-ch14-broadcasting-automata](pages/aucm-ch14-broadcasting-automata.md)] - city block and chessboard, diamond and square waves, the first two discrete discs
...
- [[neighbourhood-sequence](pages/neighbourhood-sequence.md)] - repeating and mixing the two neighbourhoods
- [[broadcasting-automaton](pages/broadcasting-automaton.md)] - Euclidean-radius broadcasts that start with these two
...
[^6]: [[aucm-ch14-broadcasting-automata](pages/aucm-ch14-broadcasting-automata.md)] pp.298, 307, 309, 328 [synthesis] — cityblock motion only horizontal and vertical, chessboard also diagonal; Fig. 14.4: diamond wave (von Neumann) and square wave (Moore); von Neumann and Moore as "the first two radii in the set of distinct discrete discs, r² = 1 and r² = 2"; "the Moore neighbourhood, L∞, the von Neumann neighbourhood, L1"
[^7]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.5 [synthesis] - von Neumann neighbourhood ‖y‖₁ ≤ 1 with 2d + 1 neighbours; Moore neighbourhood ‖y‖∞ ≤ 1 with 3ᵈ neighbours; radius-r CA; "Moore neighborhood is of radius 1"; radius-½ offsets with each yᵢ 0 or 1; "A one-dimensional, radius-½ CA is also called one-way, or OCA for short"; information cannot flow to the positive direction
[^8]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] pp.16, 24, 29 [synthesis] - XOR is "a one-dimensional radius-½ CA"; the 1D nilpotency construction uses neighbourhood (0, 1); one-way CA (OCA) in language recognition
[^9]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] p.18 - "Strictly speaking Margolus neighborhood is not a CA neighborhood in the sense of our definitions."
