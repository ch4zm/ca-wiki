...
The R-pentomino is a five-cell polyomino and the classic
[[methuselah](pages/methuselah.md)]. It takes 1,103 generations to stabilize, much
longer than any other pattern that fits in a 3 × 3 bounding box and any other polyomino
with 5 or fewer cells.[^1] It is the only one of the 12 pentominoes that does not end
quickly by vanishing, stabilizing or oscillating.[^2] Some 5-cell non-polyominoes last
slightly longer; its grandparents last 1,105 generations.[^3]
...
- in generation 69, the first [[glider](pages/glider.md)] ever observed in Life,
  noticed by Richard K. Guy while evolving it by hand on a Go board.[^5]
...
- [[cgol-ch1-early-life](pages/cgol-ch1-early-life.md)] - lifespan, products, first glider
- [[fantastic-combinations-of-john-conways-life](pages/fantastic-combinations-of-john-conways-life.md)] - the pentomino survey

## Related Concepts

- [[methuselah](pages/methuselah.md)] - its class
- [[glider](pages/glider.md)] - first observed in its evolution
- [[familiar-fours](pages/familiar-fours.md)] - the unstable objects it passes through

[^1]: [[cgol-ch1-early-life](pages/cgol-ch1-early-life.md)] p.17 [synthesis] - "it takes considerably longer to stabilize than any other pattern that fits with in a 3 × 3 bounding box, and also much longer to stabilize than any other polyomino with 5 or fewer live cells"; Fig. 1.28: "An R-pentomino takes 1 103 generations to stabilize"
...
[^4]: [[cgol-ch1-early-life](pages/cgol-ch1-early-life.md)] p.17 - "it produces a B-heptomino (well, actually a B-heptaplet that evolves in the same way) in generation 28, an important object called a Herschel in generation 48, and the very first glider that was ever observed in Life in generation 69"; n.20 first noticed by Richard K. Guy
