...
title: Jarkko Kari
category: People
summary: University of Turku mathematician whose results on decidability of cellular automata (2D reversibility and surjectivity, 1D nilpotency, Rice's theorem for limit sets, block representation of reversible CA, small aperiodic Wang tile sets) are surveyed in his 2005 tutorial
...
Jarkko Kari wrote "Theory of cellular automata: A survey" (2005) at the Department of
Mathematics, University of Turku, Finland, with support from the Academy of Finland.[^1]
...
- **The tiling problem stays undecidable for NW-deterministic tile sets**, and
  **nilpotency of 1D CA is undecidable** (1992) ([[limit-set](pages/limit-set.md)]).
...
- **Small aperiodic Wang tile sets** (1996). The smallest known set, 13 tiles, is cited
  to his paper and Culik's of the same year together.
- The topological entropy of a CA is uncomputable (1992, with Hurd and Culik), and work
  on linear CA with several state variables (2000).
...
- [[decidability-in-cellular-automata](pages/decidability-in-cellular-automata.md)] - where his results sit among the others
