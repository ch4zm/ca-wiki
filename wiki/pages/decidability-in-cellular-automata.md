...
| Question | 1D | 2D and higher | Page |
|---|---|---|---|
...
| Any non-trivial property of the limit set | undecidable (Kari) | undecidable | [[limit-set](pages/limit-set.md)] |
...
| Positively expansive (K4)? | **open** | trivially no: none exist | [[chaos-in-cellular-automata](pages/chaos-in-cellular-automata.md)] |
| Does a finite Life configuration die? | | undecidable (Berlekamp, Conway and Guy) | [[game-of-life](pages/game-of-life.md)] |
| Surjective, injective, equicontinuous, sensitive, transitive, positively expansive, for **linear** rules over ℤ_m | decidable by gcd tests | decidable by gcd tests (positive expansivity impossible) | [[additive-cellular-automaton](pages/additive-cellular-automaton.md)] |
...
linear rules.[^8] Blank cells are cases the survey does not state. (Own reasoning:
...
tiling exists. Layering the SNAKES set under an XOR layer gives a CA that is injective iff
no tiling exists. The finite tiling problem does the same for surjectivity and for
conserved quantities.[^11]

**Nilpotency breaks the pattern.** It is undecidable even in 1D, because a space-time
diagram of a 1D CA *is* a tiling by an NW-deterministic set, and tiling stays undecidable
for those sets. Kari's Rice theorem then spreads that one undecidable problem to every
...
- [[jarkko-kari](pages/jarkko-kari.md)] - author of most of the undecidability results
...
[^5]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] pp.24-25 [synthesis] - Theorem 15 (Culik et al. [19], Kari [40]), with the 2D and 1D proofs; topological entropy uncomputable [35]; Theorem 16 for every d ≥ 1
...
[^8]: [[theory-of-cellular-automata-a-survey](pages/theory-of-cellular-automata-a-survey.md)] pp.28-29 [synthesis] - Theorem 17, Corollary 4, Theorem 18; "all the given conditions are fast to test"; "Higher dimensional positively expansive CA do not exist"
