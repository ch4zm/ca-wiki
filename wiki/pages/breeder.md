...
sources: [cgol-ch6-periodic-circuitry, cgol-ch5-glider-synthesis]
created: 2026-09-25
updated: 2026-09-25
---
...
A compact version uses six period-60 space rakes by building the hardest part, a ship,
from the debris of the front two rakes. It lays the gun rows of the [[primer](pages/primer.md)].[^3]

Bill Gosper built the first breeder in the early 1970s on the same plan, using a
different puffer in place of the space rakes.[^4]
...
[^3]: [[cgol-ch6-periodic-circuitry](pages/cgol-ch6-periodic-circuitry.md)] pp.161-163 [synthesis] - Fig. 6.20 "A compact breeder that uses 6 period 60 space rakes"; "cleverly manipulates the debris behind the two frontmost space rakes to create a ship"; used as a component of the primer
[^4]: [[cgol-ch5-glider-synthesis](pages/cgol-ch5-glider-synthesis.md)] p.135, n.7 - "The first breeder was found by Bill Gosper in the early 1970s. It used the exact same ideas that we used in the construction of our breeder, but used a different puffer in place of the space rakes"
